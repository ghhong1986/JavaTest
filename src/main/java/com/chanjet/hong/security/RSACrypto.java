package com.chanjet.hong.security;
...
public class RSACrypto {
	...
	public static String encryptByPublicKey(String message, String publicKeyFile) throws Exception {
		...
		publicKey = publicKey.replaceAll("-----BEGIN PUBLIC KEY-----", "").replaceAll("-----END PUBLIC KEY-----", "")
				.replaceAll("-----BEGIN RSA PUBLIC KEY-----", "").replaceAll("-----END RSA PUBLIC KEY-----", "")
				.replace("\n", "").trim();
	...
	public static String decryptByPrivateKey(String message, String privateKeyFile) throws Exception {
		...
		privateKey = privateKey.replaceAll("-----BEGIN RSA PRIVATE KEY-----", "")
				.replaceAll("-----END RSA PRIVATE KEY-----", "").replaceAll("-----BEGIN PRIVATE KEY-----", "")
...
//		byte[] keyBytes = new BASE64Decoder().decodeBuffer(privateKey);
	...
	public static void main(String[] args) {
		String content   = "2016年4月25日 - 注意:验证算法和RSA加密体制中的加密算法非常像.";
		String publicKey  = "/Users/honggh/log/rsa_public_key.pem";
		String privateKey = "/Users/honggh/log/rsa_private_key.pem";
		System.out.println(content);
		try{
			String entryStr = encryptByPublicKey(content, publicKey);
			
			entryStr = entryStr.replace("\r", "");
			System.out.println(entryStr);
			
			String decryptStr = decryptByPrivateKey(content, privateKey);
