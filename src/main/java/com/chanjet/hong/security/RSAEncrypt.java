...
public class RSAEncrypt {
	...
	public static void main(String[] args){
		...
		String privateKey = "/Users/honggh/log/pkcs8_rsa_private_key.pem";
		//加载公钥
		try {
//			rsaEncrypt.loadPublicKey(RSAEncrypt.DEFAULT_PUBLIC_KEY);
		    FileInputStream fis = new FileInputStream(new File(publicKey));
		...
		//加载私钥
		try {
			   FileInputStream fis = new FileInputStream(new File(privateKey));
