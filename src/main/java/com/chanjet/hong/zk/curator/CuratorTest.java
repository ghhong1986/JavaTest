...
public class CuratorTest {
	...
	public CuratorTest() {
		zkTools = CuratorFrameworkFactory.builder().connectString("se244:2181").retryPolicy(new RetryNTimes(2000, 20000)).build();
		zkTools.start();
		//.namespace("/distlock/mq")
	}
	...
	public void register() throws Exception {
		...
		String registeNode = ip;// 节点路径   "zk/register/" +
